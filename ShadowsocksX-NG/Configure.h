...
static NSString * const USERDEFAULTS_OPEN_SERVERS_LIST_PRO_VIEW = @"USERDEFAULTS_OPEN_SERVERS_LIST_PRO_VIEW";
static NSString * const USERDEFAULTS_OPEN_WEBSERVERS = @"USERDEFAULTS_OPEN_WEBSERVERS";
static NSString * const USERDEFAULTS_WEBSERVERS_LISTEN_PORT = @"USERDEFAULTS_WEBSERVERS_LISTEN_PORT";
